...
const TIPS: Tip[] = [
  ...
  "Use {highlight}subtext run{/highlight} for non-interactive scripting",
  "Use {highlight}subtext --continue{/highlight} to resume the last session",
  "Use {highlight}subtext run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}subtext serve{/highlight} for headless API access to Subtext",
  "Use {highlight}subtext run --attach{/highlight} to connect to a running server",
  "Run {highlight}subtext upgrade{/highlight} to update to the latest version",
  "Run {highlight}subtext auth list{/highlight} to see all configured providers",
  "Run {highlight}subtext agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}subtext github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}subtext debug config{/highlight} to troubleshoot configuration",
